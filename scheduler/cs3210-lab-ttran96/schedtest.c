...
//    sched_test1(5, SCHED_RR, SCHED_RR, 0, 0);   // DEFAULT
    sched_test1(5, SCHED_RR, SCHED_RR, 99, 0);   // create all child, and then execute child
//    sched_test1(5, SCHED_RR, SCHED_FIFO, 0, 0);   // create child, execute til DONE, then create next child
//    sched_test1(5, SCHED_FIFO, SCHED_RR, 0, 0, 4000000000);   // create all child, execute child in RR
    sched_test1(5, SCHED_FIFO, SCHED_FIFO, 99, 0); // creaate all child, execute child in FIFO
