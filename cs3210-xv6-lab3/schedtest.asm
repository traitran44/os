...
main(int argc, char *argv[]) {
   ...
   e:	83 ec 10             	sub    $0x10,%esp
    sched_test(4);
  11:	6a 04                	push   $0x4
  13:	e8 08 00 00 00       	call   20 <sched_test>
    exit();
  18:	e8 05 03 00 00       	call   322 <exit>
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
...
sched_test(int num_proc) {
  ...
  2f:	e8 a6 03 00 00       	call   3da <setscheduler>
    for (int i = 0; i < num_proc; i++) {
  34:	8b 45 08             	mov    0x8(%ebp),%eax
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	7e 5f                	jle    9d <sched_test+0x7d>
  3e:	8b 45 08             	mov    0x8(%ebp),%eax
  41:	bb 03 00 00 00       	mov    $0x3,%ebx
  46:	8d 78 03             	lea    0x3(%eax),%edi
            if (i == num_proc - 1) {
  49:	83 e8 01             	sub    $0x1,%eax
  4c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  4f:	eb 16                	jmp    67 <sched_test+0x47>
  51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  58:	8d 43 fd             	lea    -0x3(%ebx),%eax
  5b:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  5e:	74 50                	je     b0 <sched_test+0x90>
  60:	83 c3 01             	add    $0x1,%ebx
    for (int i = 0; i < num_proc; i++) {
  63:	39 df                	cmp    %ebx,%edi
  65:	74 36                	je     9d <sched_test+0x7d>
        int pid = fork();
  67:	e8 ae 02 00 00       	call   31a <fork>
  ...
  72:	6a 00                	push   $0x0
  74:	50                   	push   %eax
  75:	e8 60 03 00 00       	call   3da <setscheduler>
        if (pid > 0) {
  7a:	83 c4 10             	add    $0x10,%esp
  7d:	83 fe 00             	cmp    $0x0,%esi
  80:	7f d6                	jg     58 <sched_test+0x38>
        } else if (pid == 0) {
  82:	74 19                	je     9d <sched_test+0x7d>
            printf(1, "Fork error\n");
  ...
  96:	83 c4 10             	add    $0x10,%esp
    for (int i = 0; i < num_proc; i++) {
  99:	39 df                	cmp    %ebx,%edi
  9b:	75 ca                	jne    67 <sched_test+0x47>
}
  ...
  b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
                    pid = wait();
  b8:	e8 6d 02 00 00       	call   32a <wait>
                for (int j = 0; j < num_proc; ++j) {
  bd:	83 c6 01             	add    $0x1,%esi
  c0:	39 75 08             	cmp    %esi,0x8(%ebp)
  c3:	75 f3                	jne    b8 <sched_test+0x98>
  c5:	eb 99                	jmp    60 <sched_test+0x40>
  c7:	66 90                	xchg   %ax,%ax
  c9:	66 90                	xchg   %ax,%ax
  cb:	66 90                	xchg   %ax,%ax
  cd:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 661:	a1 d0 0a 00 00       	mov    0xad0,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 d0 0a 00 00       	mov    %eax,0xad0
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 d0 0a 00 00    	mov    0xad0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 d0 0a 00 00    	mov    %edx,0xad0
}
 ...
 7b7:	0a 00 00 
 7ba:	c7 05 d4 0a 00 00 d4 	movl   $0xad4,0xad4
 7c1:	0a 00 00 
    base.s.size = 0;
 7c4:	b8 d4 0a 00 00       	mov    $0xad4,%eax
 7c9:	c7 05 d8 0a 00 00 00 	movl   $0x0,0xad8
 7d0:	00 00 00 
