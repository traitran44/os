...
00000110 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     116:	68 7c 3d 00 00       	push   $0x3d7c
     11b:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     121:	e8 6a 38 00 00       	call   3990 <printf>
  if(mkdir("iputdir") < 0){
     126:	c7 04 24 0f 3d 00 00 	movl   $0x3d0f,(%esp)
  ...
  if(chdir("iputdir") < 0){
     ...
     13c:	68 0f 3d 00 00       	push   $0x3d0f
  ...
  if(unlink("../iputdir") < 0){
     ...
     154:	68 0c 3d 00 00       	push   $0x3d0c
  ...
  if(chdir("/") < 0){
     ...
     168:	68 31 3d 00 00       	push   $0x3d31
  ...
  printf(stdout, "iput test ok\n");
     ...
     17c:	68 b4 3d 00 00       	push   $0x3db4
     181:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "mkdir failed\n");
     191:	50                   	push   %eax
     192:	50                   	push   %eax
     193:	68 e8 3c 00 00       	push   $0x3ce8
     198:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "chdir / failed\n");
     1a8:	50                   	push   %eax
     1a9:	50                   	push   %eax
     1aa:	68 33 3d 00 00       	push   $0x3d33
     1af:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     1bf:	52                   	push   %edx
     1c0:	52                   	push   %edx
     1c1:	68 17 3d 00 00       	push   $0x3d17
     1c6:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "chdir iputdir failed\n");
     1d6:	51                   	push   %ecx
     1d7:	51                   	push   %ecx
     1d8:	68 f6 3c 00 00       	push   $0x3cf6
     1dd:	ff 35 4c 5d 00 00    	pushl  0x5d4c
...
000001f0 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     1f6:	68 43 3d 00 00       	push   $0x3d43
     1fb:	ff 35 4c 5d 00 00    	pushl  0x5d4c
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     21b:	68 0f 3d 00 00       	push   $0x3d0f
    ...
    if(chdir("iputdir") < 0){
     ...
     233:	68 0f 3d 00 00       	push   $0x3d0f
    ...
    if(unlink("../iputdir") < 0){
     ...
     247:	68 0c 3d 00 00       	push   $0x3d0c
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     268:	68 66 3d 00 00       	push   $0x3d66
     26d:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     ...
     283:	68 17 3d 00 00       	push   $0x3d17
     288:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "fork failed\n");
     298:	51                   	push   %ecx
     299:	51                   	push   %ecx
     29a:	68 29 4c 00 00       	push   $0x4c29
     29f:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    exit();
     ...
     2af:	50                   	push   %eax
     2b0:	50                   	push   %eax
     2b1:	68 52 3d 00 00       	push   $0x3d52
     2b6:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     ...
     2c6:	52                   	push   %edx
     2c7:	52                   	push   %edx
     2c8:	68 e8 3c 00 00       	push   $0x3ce8
     2cd:	ff 35 4c 5d 00 00    	pushl  0x5d4c
...
000002e0 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     2e6:	68 78 3d 00 00       	push   $0x3d78
     2eb:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     2f1:	e8 9a 36 00 00       	call   3990 <printf>
  if(mkdir("oidir") < 0){
     2f6:	c7 04 24 87 3d 00 00 	movl   $0x3d87,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     31f:	6a 02                	push   $0x2
     321:	68 87 3d 00 00       	push   $0x3d87
    ...
    if(fd >= 0){
     ...
     335:	68 e8 4c 00 00       	push   $0x4ce8
     33a:	ff 35 4c 5d 00 00    	pushl  0x5d4c
  ...
  if(unlink("oidir") != 0){
     35a:	c7 04 24 87 3d 00 00 	movl   $0x3d87,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     375:	68 b0 3d 00 00       	push   $0x3db0
     37a:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "mkdir oidir failed\n");
     395:	51                   	push   %ecx
     396:	51                   	push   %ecx
     397:	68 8d 3d 00 00       	push   $0x3d8d
     39c:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "fork failed\n");
     3ac:	52                   	push   %edx
     3ad:	52                   	push   %edx
     3ae:	68 29 4c 00 00       	push   $0x4c29
     3b3:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "unlink failed\n");
     3c3:	50                   	push   %eax
     3c4:	50                   	push   %eax
     3c5:	68 a1 3d 00 00       	push   $0x3da1
     3ca:	ff 35 4c 5d 00 00    	pushl  0x5d4c
...
000003e0 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     3e6:	68 c2 3d 00 00       	push   $0x3dc2
     3eb:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     3f1:	e8 9a 35 00 00       	call   3990 <printf>
  fd = open("echo", 0);
     3f6:	58                   	pop    %eax
     3f7:	5a                   	pop    %edx
     3f8:	6a 00                	push   $0x0
     3fa:	68 cd 3d 00 00       	push   $0x3dcd
  ...
  fd = open("doesnotexist", 0);
     ...
     415:	59                   	pop    %ecx
     416:	6a 00                	push   $0x0
     418:	68 e5 3d 00 00       	push   $0x3de5
  ...
  printf(stdout, "open test ok\n");
     ...
     42c:	68 10 3e 00 00       	push   $0x3e10
     431:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "open echo failed!\n");
     441:	50                   	push   %eax
     442:	50                   	push   %eax
     443:	68 d2 3d 00 00       	push   $0x3dd2
     448:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     458:	50                   	push   %eax
     459:	50                   	push   %eax
     45a:	68 f2 3d 00 00       	push   $0x3df2
     45f:	ff 35 4c 5d 00 00    	pushl  0x5d4c
...
00000470 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     478:	68 1e 3e 00 00       	push   $0x3e1e
     47d:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     483:	e8 08 35 00 00       	call   3990 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     488:	58                   	pop    %eax
     489:	5a                   	pop    %edx
     48a:	68 02 02 00 00       	push   $0x202
     48f:	68 2f 3e 00 00       	push   $0x3e2f
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4ab:	68 35 3e 00 00       	push   $0x3e35
     4b0:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4c3:	6a 0a                	push   $0xa
     4c5:	68 6c 3e 00 00       	push   $0x3e6c
     4ca:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4df:	6a 0a                	push   $0xa
     4e1:	68 77 3e 00 00       	push   $0x3e77
     4e6:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     503:	68 82 3e 00 00       	push   $0x3e82
     508:	ff 35 4c 5d 00 00    	pushl  0x5d4c
  ...
  fd = open("small", O_RDONLY);
     ...
     51c:	5e                   	pop    %esi
     51d:	6a 00                	push   $0x0
     51f:	68 2f 3e 00 00       	push   $0x3e2f
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     539:	68 8d 3e 00 00       	push   $0x3e8d
     53e:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     544:	e8 47 34 00 00       	call   3990 <printf>
  i = read(fd, buf, 2000);
     549:	83 c4 0c             	add    $0xc,%esp
     54c:	68 d0 07 00 00       	push   $0x7d0
     551:	68 40 85 00 00       	push   $0x8540
     556:	53                   	push   %ebx
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     56d:	68 c1 3e 00 00       	push   $0x3ec1
     572:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     578:	e8 13 34 00 00       	call   3990 <printf>
  close(fd);
     57d:	89 1c 24             	mov    %ebx,(%esp)
     580:	e8 c5 32 00 00       	call   384a <close>
  if(unlink("small") < 0){
     585:	c7 04 24 2f 3e 00 00 	movl   $0x3e2f,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     59b:	68 e9 3e 00 00       	push   $0x3ee9
     5a0:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     ...
     5b8:	53                   	push   %ebx
     5b9:	68 0c 4d 00 00       	push   $0x4d0c
     5be:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     ...
     5d1:	53                   	push   %ebx
     5d2:	68 30 4d 00 00       	push   $0x4d30
     5d7:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "error: open small failed!\n");
     5e7:	51                   	push   %ecx
     5e8:	51                   	push   %ecx
     5e9:	68 a6 3e 00 00       	push   $0x3ea6
     5ee:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "read failed\n");
     5fe:	52                   	push   %edx
     5ff:	52                   	push   %edx
     600:	68 ed 41 00 00       	push   $0x41ed
     605:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "unlink small failed\n");
     615:	50                   	push   %eax
     616:	50                   	push   %eax
     617:	68 d4 3e 00 00       	push   $0x3ed4
     61c:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "error: creat small failed!\n");
     62c:	50                   	push   %eax
     62d:	50                   	push   %eax
     62e:	68 50 3e 00 00       	push   $0x3e50
     633:	ff 35 4c 5d 00 00    	pushl  0x5d4c
...
00000650 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     658:	68 fd 3e 00 00       	push   $0x3efd
     65d:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     663:	e8 28 33 00 00       	call   3990 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     668:	58                   	pop    %eax
     669:	5a                   	pop    %edx
     66a:	68 02 02 00 00       	push   $0x202
     66f:	68 77 3f 00 00       	push   $0x3f77
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     693:	89 1d 40 85 00 00    	mov    %ebx,0x8540
    if(write(fd, buf, 512) != 512){
     699:	68 00 02 00 00       	push   $0x200
     69e:	68 40 85 00 00       	push   $0x8540
     6a3:	56                   	push   %esi
  ...
  fd = open("big", O_RDONLY);
     ...
     6cc:	5e                   	pop    %esi
     6cd:	6a 00                	push   $0x0
     6cf:	68 77 3f 00 00       	push   $0x3f77
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     6fb:	a1 40 85 00 00       	mov    0x8540,%eax
    ...
    i = read(fd, buf, 512);
     ...
     70f:	68 40 85 00 00       	push   $0x8540
     714:	56                   	push   %esi
  ...
  if(unlink("big") < 0){
     736:	c7 04 24 77 3f 00 00 	movl   $0x3f77,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     750:	68 9e 3f 00 00       	push   $0x3f9e
     755:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     ...
     76d:	53                   	push   %ebx
     76e:	68 27 3f 00 00       	push   $0x3f27
     773:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     ...
     783:	50                   	push   %eax
     784:	53                   	push   %ebx
     785:	68 54 4d 00 00       	push   $0x4d54
     78a:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     ...
     79d:	50                   	push   %eax
     79e:	68 7b 3f 00 00       	push   $0x3f7b
     7a3:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     ...
     7b9:	68 5e 3f 00 00       	push   $0x3f5e
     7be:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "error: open big failed!\n");
     7ce:	51                   	push   %ecx
     7cf:	51                   	push   %ecx
     7d0:	68 45 3f 00 00       	push   $0x3f45
     7d5:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "error: creat big failed!\n");
     7e5:	50                   	push   %eax
     7e6:	50                   	push   %eax
     7e7:	68 0d 3f 00 00       	push   $0x3f0d
     7ec:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "unlink big failed\n");
     7fc:	50                   	push   %eax
     7fd:	50                   	push   %eax
     7fe:	68 8b 3f 00 00       	push   $0x3f8b
     803:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     ...
     824:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     82c:	68 74 4d 00 00       	push   $0x4d74
     831:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     837:	e8 54 31 00 00       	call   3990 <printf>
  name[0] = 'a';
     83c:	c6 05 40 a5 00 00 61 	movb   $0x61,0xa540
  name[2] = '\0';
     843:	c6 05 42 a5 00 00 00 	movb   $0x0,0xa542
     84a:	83 c4 10             	add    $0x10,%esp
     84d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     850:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     853:	88 1d 41 a5 00 00    	mov    %bl,0xa541
     859:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     85c:	68 02 02 00 00       	push   $0x202
     861:	68 40 a5 00 00       	push   $0xa540
  ...
  name[0] = 'a';
     87b:	c6 05 40 a5 00 00 61 	movb   $0x61,0xa540
  name[2] = '\0';
     882:	c6 05 42 a5 00 00 00 	movb   $0x0,0xa542
     889:	bb 30 00 00 00       	mov    $0x30,%ebx
     88e:	66 90                	xchg   %ax,%ax
    unlink(name);
     890:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     893:	88 1d 41 a5 00 00    	mov    %bl,0xa541
     899:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     89c:	68 40 a5 00 00       	push   $0xa540
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8b1:	68 9c 4d 00 00       	push   $0x4d9c
     8b6:	ff 35 4c 5d 00 00    	pushl  0x5d4c
...
000008d0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     8d6:	68 ac 3f 00 00       	push   $0x3fac
     8db:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     8e1:	e8 aa 30 00 00       	call   3990 <printf>
  if(mkdir("dir0") < 0){
     8e6:	c7 04 24 b8 3f 00 00 	movl   $0x3fb8,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     8fc:	68 b8 3f 00 00       	push   $0x3fb8
  ...
  if(chdir("..") < 0){
     ...
     914:	68 5d 45 00 00       	push   $0x455d
  ...
  if(unlink("dir0") < 0){
     ...
     928:	68 b8 3f 00 00       	push   $0x3fb8
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     93c:	68 f5 3f 00 00       	push   $0x3ff5
     941:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "mkdir failed\n");
     951:	50                   	push   %eax
     952:	50                   	push   %eax
     953:	68 e8 3c 00 00       	push   $0x3ce8
     958:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "unlink dir0 failed\n");
     968:	50                   	push   %eax
     969:	50                   	push   %eax
     96a:	68 e1 3f 00 00       	push   $0x3fe1
     96f:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "chdir .. failed\n");
     97f:	52                   	push   %edx
     980:	52                   	push   %edx
     981:	68 d0 3f 00 00       	push   $0x3fd0
     986:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    printf(stdout, "chdir dir0 failed\n");
     996:	51                   	push   %ecx
     997:	51                   	push   %ecx
     998:	68 bd 3f 00 00       	push   $0x3fbd
     99d:	ff 35 4c 5d 00 00    	pushl  0x5d4c
...
000009b0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     9b6:	68 04 40 00 00       	push   $0x4004
     9bb:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     9c1:	e8 ca 2f 00 00       	call   3990 <printf>
  if(exec("echo", echoargv) < 0){
     9c6:	5a                   	pop    %edx
     9c7:	59                   	pop    %ecx
     9c8:	68 50 5d 00 00       	push   $0x5d50
     9cd:	68 cd 3d 00 00       	push   $0x3dcd
    ...
    printf(stdout, "exec echo failed\n");
     9e0:	50                   	push   %eax
     9e1:	50                   	push   %eax
     9e2:	68 0f 40 00 00       	push   $0x400f
     9e7:	ff 35 4c 5d 00 00    	pushl  0x5d4c
     ...
     a06:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a50:	57                   	push   %edi
     a51:	68 40 85 00 00       	push   $0x8540
     ...
     a6e:	f7 d9                	neg    %ecx
     a70:	38 9c 0b 40 85 00 00 	cmp    %bl,0x8540(%ebx,%ecx,1)
     ...
     a9a:	68 3e 40 00 00       	push   $0x403e
     a9f:	6a 01                	push   $0x1
    ...
    close(fds[0]);
     ...
     ace:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     ad0:	88 84 03 40 85 00 00 	mov    %al,0x8540(%ebx,%eax,1)
     ...
     ae6:	68 40 85 00 00       	push   $0x8540
  ...
  printf(1, "pipe1 ok\n");
     b2d:	5a                   	pop    %edx
     b2e:	59                   	pop    %ecx
     b2f:	68 63 40 00 00       	push   $0x4063
     b34:	6a 01                	push   $0x1
     ...
     b4a:	68 4c 40 00 00       	push   $0x404c
     b4f:	6a 01                	push   $0x1
    ...
    printf(1, "pipe() failed\n");
     b5b:	57                   	push   %edi
     b5c:	57                   	push   %edi
     b5d:	68 21 40 00 00       	push   $0x4021
     b62:	6a 01                	push   $0x1
    ...
    printf(1, "fork() failed\n");
     b6e:	50                   	push   %eax
     b6f:	50                   	push   %eax
     b70:	68 6d 40 00 00       	push   $0x406d
     b75:	6a 01                	push   $0x1
    ...
    exit();
     ...
     b81:	56                   	push   %esi
     b82:	56                   	push   %esi
     b83:	68 30 40 00 00       	push   $0x4030
     b88:	6a 01                	push   $0x1
...
00000ba0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     ba9:	68 7c 40 00 00       	push   $0x407c
     bae:	6a 01                	push   $0x1
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bfa:	6a 01                	push   $0x1
     bfc:	68 41 46 00 00       	push   $0x4641
     ...
     c11:	50                   	push   %eax
     c12:	50                   	push   %eax
     c13:	68 86 40 00 00       	push   $0x4086
     c18:	6a 01                	push   $0x1
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c45:	68 40 85 00 00       	push   $0x8540
    ...
    printf(1, "preempt read error");
     c5a:	50                   	push   %eax
     c5b:	50                   	push   %eax
     c5c:	68 9a 40 00 00       	push   $0x409a
     c61:	6a 01                	push   $0x1
  ...
  printf(1, "kill... ");
     c7e:	58                   	pop    %eax
     c7f:	5a                   	pop    %edx
     c80:	68 ad 40 00 00       	push   $0x40ad
     c85:	6a 01                	push   $0x1
  ...
  printf(1, "wait... ");
     ca4:	59                   	pop    %ecx
     ca5:	5b                   	pop    %ebx
     ca6:	68 b6 40 00 00       	push   $0x40b6
     cab:	6a 01                	push   $0x1
  ...
  printf(1, "preempt ok\n");
     cc1:	5e                   	pop    %esi
     cc2:	5f                   	pop    %edi
     cc3:	68 bf 40 00 00       	push   $0x40bf
     cc8:	6a 01                	push   $0x1
...
00000ce0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d0e:	68 29 4c 00 00       	push   $0x4c29
     d13:	6a 01                	push   $0x1
     ...
     d2b:	68 cb 40 00 00       	push   $0x40cb
     d30:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
     ...
     d4b:	68 db 40 00 00       	push   $0x40db
     d50:	6a 01                	push   $0x1
...
00000d70 <mem>:
{
  ...
  printf(1, "mem test\n");
     d7b:	68 e8 40 00 00       	push   $0x40e8
     d80:	6a 01                	push   $0x1
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     df1:	58                   	pop    %eax
     df2:	5a                   	pop    %edx
     df3:	68 0c 41 00 00       	push   $0x410c
     df8:	6a 01                	push   $0x1
    ...
    exit();
     ...
     e0b:	68 f2 40 00 00       	push   $0x40f2
     e10:	6a 01                	push   $0x1
...
00000e40 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecf:	68 f0 4d 00 00       	push   $0x4df0
     ed4:	6a 01                	push   $0x1
  ...
  fd = open("sharedfd", 0);
     ...
     efc:	5a                   	pop    %edx
     efd:	6a 00                	push   $0x0
     eff:	68 23 41 00 00       	push   $0x4123
  ...
  unlink("sharedfd");
     f71:	c7 04 24 23 41 00 00 	movl   $0x4123,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     f93:	68 2c 41 00 00       	push   $0x412c
     f98:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fb3:	68 c4 4d 00 00       	push   $0x4dc4
     fb8:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fcd:	68 10 4e 00 00       	push   $0x4e10
     fd2:	6a 01                	push   $0x1
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     fe9:	53                   	push   %ebx
     fea:	57                   	push   %edi
     feb:	68 39 41 00 00       	push   $0x4139
     ff0:	6a 01                	push   $0x1
...
00001000 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1006:	be 4e 41 00 00       	mov    $0x414e,%esi
  for(pi = 0; pi < 4; pi++){
    100b:	31 db                	xor    %ebx,%ebx
{
    100d:	83 ec 34             	sub    $0x34,%esp
  char *names[] = { "f0", "f1", "f2", "f3" };
    1010:	c7 45 d8 4e 41 00 00 	movl   $0x414e,-0x28(%ebp)
    1017:	c7 45 dc 97 42 00 00 	movl   $0x4297,-0x24(%ebp)
  printf(1, "fourfiles test\n");
    101e:	68 54 41 00 00       	push   $0x4154
    1023:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    1025:	c7 45 e0 9b 42 00 00 	movl   $0x429b,-0x20(%ebp)
    102c:	c7 45 e4 51 41 00 00 	movl   $0x4151,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
  ...
  for(i = 0; i < 2; i++){
    ...
    107e:	c7 45 d0 4e 41 00 00 	movl   $0x414e,-0x30(%ebp)
    fd = open(fname, 0);
    ...
    10a8:	68 40 85 00 00       	push   $0x8540
    ...
    10be:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    10c0:	0f be b2 40 85 00 00 	movsbl 0x8540(%edx),%esi
  ...
  printf(1, "fourfiles ok\n");
    ...
    1112:	68 92 41 00 00       	push   $0x4192
    1117:	6a 01                	push   $0x1
    ...
    1161:	68 40 85 00 00       	push   $0x8540
    ...
    1176:	68 40 85 00 00       	push   $0x8540
    117b:	56                   	push   %esi
    ...
    1198:	68 75 41 00 00       	push   $0x4175
    119d:	6a 01                	push   $0x1
    ...
    11a9:	51                   	push   %ecx
    11aa:	51                   	push   %ecx
    11ab:	68 ef 43 00 00       	push   $0x43ef
    11b0:	6a 01                	push   $0x1
    ...
    11bc:	53                   	push   %ebx
    11bd:	53                   	push   %ebx
    11be:	68 29 4c 00 00       	push   $0x4c29
    11c3:	6a 01                	push   $0x1
    ...
    11cf:	50                   	push   %eax
    11d0:	53                   	push   %ebx
    11d1:	68 81 41 00 00       	push   $0x4181
    11d6:	6a 01                	push   $0x1
    ...
    11e2:	52                   	push   %edx
    11e3:	50                   	push   %eax
    11e4:	68 64 41 00 00       	push   $0x4164
    11e9:	6a 01                	push   $0x1
    ...
    1206:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    120b:	68 a0 41 00 00       	push   $0x41a0
    1210:	6a 01                	push   $0x1
  ...
  printf(1, "createdelete ok\n");
    ...
    1304:	68 b3 41 00 00       	push   $0x41b3
    1309:	6a 01                	push   $0x1
    ...
    13a2:	52                   	push   %edx
    13a3:	52                   	push   %edx
    13a4:	68 a1 3d 00 00       	push   $0x3da1
    13a9:	6a 01                	push   $0x1
    ...
    13c0:	57                   	push   %edi
    13c1:	68 3c 4e 00 00       	push   $0x4e3c
    13c6:	6a 01                	push   $0x1
    ...
    13d2:	51                   	push   %ecx
    13d3:	51                   	push   %ecx
    13d4:	68 ef 43 00 00       	push   $0x43ef
    13d9:	6a 01                	push   $0x1
    ...
    13e5:	53                   	push   %ebx
    13e6:	53                   	push   %ebx
    13e7:	68 29 4c 00 00       	push   $0x4c29
    13ec:	6a 01                	push   $0x1
    ...
    1400:	50                   	push   %eax
    1401:	57                   	push   %edi
    1402:	68 60 4e 00 00       	push   $0x4e60
    1407:	6a 01                	push   $0x1
...
00001420 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1428:	68 c4 41 00 00       	push   $0x41c4
    142d:	6a 01                	push   $0x1
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    143b:	68 d5 41 00 00       	push   $0x41d5
  ...
  write(fd, "hello", 5);
    ...
    1455:	6a 05                	push   $0x5
    1457:	68 fa 41 00 00       	push   $0x41fa
    145c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    146b:	5a                   	pop    %edx
    146c:	6a 02                	push   $0x2
    146e:	68 d5 41 00 00       	push   $0x41d5
  ...
  if(unlink("unlinkread") != 0){
    ...
    1488:	68 d5 41 00 00       	push   $0x41d5
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14a5:	68 d5 41 00 00       	push   $0x41d5
  ...
  write(fd1, "yyy", 3);
    14b4:	6a 03                	push   $0x3
    14b6:	68 32 42 00 00       	push   $0x4232
    14bb:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14d1:	68 40 85 00 00       	push   $0x8540
    14d6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14e8:	80 3d 40 85 00 00 68 	cmpb   $0x68,0x8540
    14ef:	75 6b                	jne    155c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    14f1:	83 ec 04             	sub    $0x4,%esp
    14f4:	6a 0a                	push   $0xa
    14f6:	68 40 85 00 00       	push   $0x8540
    14fb:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    1512:	c7 04 24 d5 41 00 00 	movl   $0x41d5,(%esp)
    1519:	e8 54 23 00 00       	call   3872 <unlink>
  printf(1, "unlinkread ok\n");
    151e:	58                   	pop    %eax
    151f:	5a                   	pop    %edx
    1520:	68 7d 42 00 00       	push   $0x427d
    1525:	6a 01                	push   $0x1
    ...
    1536:	51                   	push   %ecx
    1537:	51                   	push   %ecx
    1538:	68 e0 41 00 00       	push   $0x41e0
    153d:	6a 01                	push   $0x1
    ...
    1549:	51                   	push   %ecx
    154a:	51                   	push   %ecx
    154b:	68 64 42 00 00       	push   $0x4264
    1550:	6a 01                	push   $0x1
    ...
    155c:	53                   	push   %ebx
    155d:	53                   	push   %ebx
    155e:	68 4d 42 00 00       	push   $0x424d
    1563:	6a 01                	push   $0x1
    ...
    156f:	56                   	push   %esi
    1570:	56                   	push   %esi
    1571:	68 36 42 00 00       	push   $0x4236
    1576:	6a 01                	push   $0x1
    ...
    1582:	50                   	push   %eax
    1583:	50                   	push   %eax
    1584:	68 18 42 00 00       	push   $0x4218
    1589:	6a 01                	push   $0x1
    ...
    1595:	50                   	push   %eax
    1596:	50                   	push   %eax
    1597:	68 00 42 00 00       	push   $0x4200
    159c:	6a 01                	push   $0x1
...
000015b0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15b7:	68 8c 42 00 00       	push   $0x428c
    15bc:	6a 01                	push   $0x1
    15be:	e8 cd 23 00 00       	call   3990 <printf>
  unlink("lf1");
    15c3:	c7 04 24 96 42 00 00 	movl   $0x4296,(%esp)
    15ca:	e8 a3 22 00 00       	call   3872 <unlink>
  unlink("lf2");
    15cf:	c7 04 24 9a 42 00 00 	movl   $0x429a,(%esp)
    15d6:	e8 97 22 00 00       	call   3872 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    15db:	58                   	pop    %eax
    15dc:	5a                   	pop    %edx
    15dd:	68 02 02 00 00       	push   $0x202
    15e2:	68 96 42 00 00       	push   $0x4296
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    15fc:	6a 05                	push   $0x5
    15fe:	68 fa 41 00 00       	push   $0x41fa
    1603:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    161e:	5b                   	pop    %ebx
    161f:	58                   	pop    %eax
    1620:	68 9a 42 00 00       	push   $0x429a
    1625:	68 96 42 00 00       	push   $0x4296
  ...
  unlink("lf1");
    ...
    163d:	68 96 42 00 00       	push   $0x4296
    1642:	e8 2b 22 00 00       	call   3872 <unlink>
  if(open("lf1", 0) >= 0){
    1647:	58                   	pop    %eax
    1648:	5a                   	pop    %edx
    1649:	6a 00                	push   $0x0
    164b:	68 96 42 00 00       	push   $0x4296
  ...
  fd = open("lf2", 0);
    ...
    1663:	6a 00                	push   $0x0
    1665:	68 9a 42 00 00       	push   $0x429a
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1684:	68 40 85 00 00       	push   $0x8540
    1689:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    16a4:	58                   	pop    %eax
    16a5:	5a                   	pop    %edx
    16a6:	68 9a 42 00 00       	push   $0x429a
    16ab:	68 9a 42 00 00       	push   $0x429a
  ...
  unlink("lf2");
    ...
    16c3:	68 9a 42 00 00       	push   $0x429a
    16c8:	e8 a5 21 00 00       	call   3872 <unlink>
  if(link("lf2", "lf1") >= 0){
    16cd:	59                   	pop    %ecx
    16ce:	5b                   	pop    %ebx
    16cf:	68 96 42 00 00       	push   $0x4296
    16d4:	68 9a 42 00 00       	push   $0x429a
  ...
  if(link(".", "lf1") >= 0){
    ...
    16e8:	68 96 42 00 00       	push   $0x4296
    16ed:	68 5e 45 00 00       	push   $0x455e
  ...
  printf(1, "linktest ok\n");
    ...
    1701:	68 34 43 00 00       	push   $0x4334
    1706:	6a 01                	push   $0x1
    ...
    1715:	50                   	push   %eax
    1716:	50                   	push   %eax
    1717:	68 9e 42 00 00       	push   $0x429e
    171c:	6a 01                	push   $0x1
    ...
    1728:	50                   	push   %eax
    1729:	50                   	push   %eax
    172a:	68 18 43 00 00       	push   $0x4318
    172f:	6a 01                	push   $0x1
    ...
    173b:	52                   	push   %edx
    173c:	52                   	push   %edx
    173d:	68 a8 4e 00 00       	push   $0x4ea8
    1742:	6a 01                	push   $0x1
    ...
    174e:	50                   	push   %eax
    174f:	50                   	push   %eax
    1750:	68 fa 42 00 00       	push   $0x42fa
    1755:	6a 01                	push   $0x1
    ...
    1761:	51                   	push   %ecx
    1762:	51                   	push   %ecx
    1763:	68 e9 42 00 00       	push   $0x42e9
    1768:	6a 01                	push   $0x1
    ...
    1774:	53                   	push   %ebx
    1775:	53                   	push   %ebx
    1776:	68 d8 42 00 00       	push   $0x42d8
    177b:	6a 01                	push   $0x1
    ...
    1787:	50                   	push   %eax
    1788:	50                   	push   %eax
    1789:	68 80 4e 00 00       	push   $0x4e80
    178e:	6a 01                	push   $0x1
    ...
    179a:	51                   	push   %ecx
    179b:	51                   	push   %ecx
    179c:	68 c3 42 00 00       	push   $0x42c3
    17a1:	6a 01                	push   $0x1
    ...
    17ad:	50                   	push   %eax
    17ae:	50                   	push   %eax
    17af:	68 b1 42 00 00       	push   $0x42b1
    17b4:	6a 01                	push   $0x1
    ...
    17cb:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  printf(1, "concreate test\n");
    17d3:	68 41 43 00 00       	push   $0x4341
    17d8:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1885:	53                   	push   %ebx
    1886:	68 54 43 00 00       	push   $0x4354
    188b:	6a 01                	push   $0x1
    ...
    18a3:	53                   	push   %ebx
    18a4:	68 51 43 00 00       	push   $0x4351
  ...
  for(i = 0; i < 40; i++){
    18c3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18c6:	53                   	push   %ebx
    18c7:	68 51 43 00 00       	push   $0x4351
  ...
  fd = open(".", 0);
    ...
    18f3:	58                   	pop    %eax
    18f4:	6a 00                	push   $0x0
    18f6:	68 5e 45 00 00       	push   $0x455e
  ...
  printf(1, "concreate ok\n");
    ...
    1a43:	68 a6 43 00 00       	push   $0x43a6
    1a48:	6a 01                	push   $0x1
    ...
    1a5a:	68 29 4c 00 00       	push   $0x4c29
    1a5f:	6a 01                	push   $0x1
    ...
    1a6b:	51                   	push   %ecx
    1a6c:	51                   	push   %ecx
    1a6d:	68 cc 4e 00 00       	push   $0x4ecc
    1a72:	6a 01                	push   $0x1
    ...
    1a81:	53                   	push   %ebx
    1a82:	50                   	push   %eax
    1a83:	68 89 43 00 00       	push   $0x4389
    1a88:	6a 01                	push   $0x1
    ...
    1a97:	56                   	push   %esi
    1a98:	50                   	push   %eax
    1a99:	68 70 43 00 00       	push   $0x4370
    1a9e:	6a 01                	push   $0x1
...
00001ac0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ac9:	68 b4 43 00 00       	push   $0x43b4
    1ace:	6a 01                	push   $0x1
    1ad0:	e8 bb 1e 00 00       	call   3990 <printf>
  unlink("x");
    1ad5:	c7 04 24 41 46 00 00 	movl   $0x4641,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b18:	68 41 46 00 00       	push   $0x4641
  ...
  for(i = 0; i < 100; i++){
    ...
    1b4d:	68 41 46 00 00       	push   $0x4641
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b76:	68 c9 43 00 00       	push   $0x43c9
    1b7b:	6a 01                	push   $0x1
    ...
    1b93:	68 41 46 00 00       	push   $0x4641
    1b98:	68 c5 43 00 00       	push   $0x43c5
    ...
    1baa:	52                   	push   %edx
    1bab:	52                   	push   %edx
    1bac:	68 29 4c 00 00       	push   $0x4c29
    1bb1:	6a 01                	push   $0x1
...
00001bd0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1bd9:	68 d8 43 00 00       	push   $0x43d8
    1bde:	6a 01                	push   $0x1
    1be0:	e8 ab 1d 00 00       	call   3990 <printf>
  unlink("bd");
    1be5:	c7 04 24 e5 43 00 00 	movl   $0x43e5,(%esp)
    1bec:	e8 81 1c 00 00       	call   3872 <unlink>
  fd = open("bd", O_CREATE);
    1bf1:	5a                   	pop    %edx
    1bf2:	59                   	pop    %ecx
    1bf3:	68 00 02 00 00       	push   $0x200
    1bf8:	68 e5 43 00 00       	push   $0x43e5
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1c2c:	57                   	push   %edi
    1c2d:	68 e5 43 00 00       	push   $0x43e5
    name[1] = '0' + (i / 64);
  ...
  unlink("bd");
    ...
    1c63:	68 e5 43 00 00       	push   $0x43e5
  ...
  printf(1, "bigdir ok\n");
    ...
    1cac:	68 27 44 00 00       	push   $0x4427
    1cb1:	6a 01                	push   $0x1
    ...
    1cc6:	68 fe 43 00 00       	push   $0x43fe
    1ccb:	6a 01                	push   $0x1
    ...
    1cda:	68 12 44 00 00       	push   $0x4412
    1cdf:	6a 01                	push   $0x1
    ...
    1ceb:	50                   	push   %eax
    1cec:	50                   	push   %eax
    1ced:	68 e8 43 00 00       	push   $0x43e8
    1cf2:	6a 01                	push   $0x1
...
00001d00 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d07:	68 32 44 00 00       	push   $0x4432
    1d0c:	6a 01                	push   $0x1
    1d0e:	e8 7d 1c 00 00       	call   3990 <printf>
  unlink("ff");
    1d13:	c7 04 24 bb 44 00 00 	movl   $0x44bb,(%esp)
    1d1a:	e8 53 1b 00 00       	call   3872 <unlink>
  if(mkdir("dd") != 0){
    1d1f:	c7 04 24 58 45 00 00 	movl   $0x4558,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d3e:	68 91 44 00 00       	push   $0x4491
  ...
  write(fd, "ff", 2);
    ...
    1d58:	6a 02                	push   $0x2
    1d5a:	68 bb 44 00 00       	push   $0x44bb
    1d5f:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1d6d:	c7 04 24 58 45 00 00 	movl   $0x4558,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d87:	68 6c 44 00 00       	push   $0x446c
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1da4:	68 8e 44 00 00       	push   $0x448e
  ...
  write(fd, "FF", 2);
    ...
    1dbe:	6a 02                	push   $0x2
    1dc0:	68 af 44 00 00       	push   $0x44af
    1dc5:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1dd4:	5a                   	pop    %edx
    1dd5:	6a 00                	push   $0x0
    1dd7:	68 b2 44 00 00       	push   $0x44b2
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1df6:	68 40 85 00 00       	push   $0x8540
    1dfb:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e0d:	80 3d 40 85 00 00 66 	cmpb   $0x66,0x8540
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e23:	5b                   	pop    %ebx
    1e24:	58                   	pop    %eax
    1e25:	68 f2 44 00 00       	push   $0x44f2
    1e2a:	68 8e 44 00 00       	push   $0x448e
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e42:	68 8e 44 00 00       	push   $0x448e
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e5a:	6a 00                	push   $0x0
    1e5c:	68 8e 44 00 00       	push   $0x448e
  ...
  if(chdir("dd") != 0){
    ...
    1e74:	68 58 45 00 00       	push   $0x4558
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1e8c:	68 26 45 00 00       	push   $0x4526
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ea4:	68 4c 45 00 00       	push   $0x454c
  ...
  if(chdir("./..") != 0){
    ...
    1ebc:	68 5b 45 00 00       	push   $0x455b
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ed4:	6a 00                	push   $0x0
    1ed6:	68 f2 44 00 00       	push   $0x44f2
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1ef5:	68 40 85 00 00       	push   $0x8540
    1efa:	50                   	push   %eax
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f16:	5b                   	pop    %ebx
    1f17:	6a 00                	push   $0x0
    1f19:	68 8e 44 00 00       	push   $0x448e
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f36:	68 a6 45 00 00       	push   $0x45a6
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f53:	68 cb 45 00 00       	push   $0x45cb
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f70:	68 58 45 00 00       	push   $0x4558
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f88:	6a 02                	push   $0x2
    1f8a:	68 58 45 00 00       	push   $0x4558
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fa2:	6a 01                	push   $0x1
    1fa4:	68 58 45 00 00       	push   $0x4558
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fbc:	68 3a 46 00 00       	push   $0x463a
    1fc1:	68 a6 45 00 00       	push   $0x45a6
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fd9:	68 3a 46 00 00       	push   $0x463a
    1fde:	68 cb 45 00 00       	push   $0x45cb
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1ff6:	68 f2 44 00 00       	push   $0x44f2
    1ffb:	68 91 44 00 00       	push   $0x4491
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2013:	68 a6 45 00 00       	push   $0x45a6
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    202b:	68 cb 45 00 00       	push   $0x45cb
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2043:	68 f2 44 00 00       	push   $0x44f2
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    205b:	68 cb 45 00 00       	push   $0x45cb
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2073:	68 a6 45 00 00       	push   $0x45a6
  ...
  if(chdir("dd/ff") == 0){
    ...
    208b:	68 91 44 00 00       	push   $0x4491
  ...
  if(chdir("dd/xx") == 0){
    ...
    20a3:	68 3d 46 00 00       	push   $0x463d
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20bb:	68 f2 44 00 00       	push   $0x44f2
  ...
  if(unlink("dd/ff") != 0){
    ...
    20d3:	68 91 44 00 00       	push   $0x4491
  ...
  if(unlink("dd") == 0){
    ...
    20eb:	68 58 45 00 00       	push   $0x4558
  ...
  if(unlink("dd/dd") < 0){
    ...
    2103:	68 6d 44 00 00       	push   $0x446d
  ...
  if(unlink("dd") < 0){
    ...
    211b:	68 58 45 00 00       	push   $0x4558
  ...
  printf(1, "subdir ok\n");
    ...
    2133:	68 3a 47 00 00       	push   $0x473a
    2138:	6a 01                	push   $0x1
    ...
    2147:	50                   	push   %eax
    2148:	50                   	push   %eax
    2149:	68 d7 44 00 00       	push   $0x44d7
    214e:	6a 01                	push   $0x1
    ...
    215a:	50                   	push   %eax
    215b:	50                   	push   %eax
    215c:	68 32 45 00 00       	push   $0x4532
    2161:	6a 01                	push   $0x1
    ...
    216d:	52                   	push   %edx
    216e:	52                   	push   %edx
    216f:	68 fd 44 00 00       	push   $0x44fd
    2174:	6a 01                	push   $0x1
    ...
    2180:	50                   	push   %eax
    2181:	50                   	push   %eax
    2182:	68 af 45 00 00       	push   $0x45af
    2187:	6a 01                	push   $0x1
    ...
    2193:	52                   	push   %edx
    2194:	52                   	push   %edx
    2195:	68 70 4f 00 00       	push   $0x4f70
    219a:	6a 01                	push   $0x1
    ...
    21a6:	52                   	push   %edx
    21a7:	52                   	push   %edx
    21a8:	68 43 46 00 00       	push   $0x4643
    21ad:	6a 01                	push   $0x1
    ...
    21b9:	51                   	push   %ecx
    21ba:	51                   	push   %ecx
    21bb:	68 e0 4f 00 00       	push   $0x4fe0
    21c0:	6a 01                	push   $0x1
    ...
    21cc:	50                   	push   %eax
    21cd:	50                   	push   %eax
    21ce:	68 be 44 00 00       	push   $0x44be
    21d3:	6a 01                	push   $0x1
    ...
    21df:	51                   	push   %ecx
    21e0:	51                   	push   %ecx
    21e1:	68 97 44 00 00       	push   $0x4497
    21e6:	6a 01                	push   $0x1
    ...
    21f2:	50                   	push   %eax
    21f3:	50                   	push   %eax
    21f4:	68 60 45 00 00       	push   $0x4560
    21f9:	6a 01                	push   $0x1
    ...
    2205:	51                   	push   %ecx
    2206:	51                   	push   %ecx
    2207:	68 28 4f 00 00       	push   $0x4f28
    220c:	6a 01                	push   $0x1
    ...
    2218:	53                   	push   %ebx
    2219:	53                   	push   %ebx
    221a:	68 bc 4f 00 00       	push   $0x4fbc
    221f:	6a 01                	push   $0x1
    ...
    222b:	50                   	push   %eax
    222c:	50                   	push   %eax
    222d:	68 98 4f 00 00       	push   $0x4f98
    2232:	6a 01                	push   $0x1
    ...
    223e:	50                   	push   %eax
    223f:	50                   	push   %eax
    2240:	68 1f 46 00 00       	push   $0x461f
    2245:	6a 01                	push   $0x1
    ...
    2251:	50                   	push   %eax
    2252:	50                   	push   %eax
    2253:	68 06 46 00 00       	push   $0x4606
    2258:	6a 01                	push   $0x1
    ...
    2264:	50                   	push   %eax
    2265:	50                   	push   %eax
    2266:	68 f0 45 00 00       	push   $0x45f0
    226b:	6a 01                	push   $0x1
    ...
    2277:	50                   	push   %eax
    2278:	50                   	push   %eax
    2279:	68 d4 45 00 00       	push   $0x45d4
    227e:	6a 01                	push   $0x1
    ...
    228a:	50                   	push   %eax
    228b:	50                   	push   %eax
    228c:	68 15 45 00 00       	push   $0x4515
    2291:	6a 01                	push   $0x1
    ...
    229d:	50                   	push   %eax
    229e:	50                   	push   %eax
    229f:	68 4c 4f 00 00       	push   $0x4f4c
    22a4:	6a 01                	push   $0x1
    ...
    22b0:	53                   	push   %ebx
    22b1:	53                   	push   %ebx
    22b2:	68 73 44 00 00       	push   $0x4473
    22b7:	6a 01                	push   $0x1
    ...
    22c3:	50                   	push   %eax
    22c4:	50                   	push   %eax
    22c5:	68 00 4f 00 00       	push   $0x4f00
    22ca:	6a 01                	push   $0x1
    ...
    22d6:	50                   	push   %eax
    22d7:	50                   	push   %eax
    22d8:	68 57 44 00 00       	push   $0x4457
    22dd:	6a 01                	push   $0x1
    ...
    22e9:	50                   	push   %eax
    22ea:	50                   	push   %eax
    22eb:	68 3f 44 00 00       	push   $0x443f
    22f0:	6a 01                	push   $0x1
    ...
    22fc:	50                   	push   %eax
    22fd:	50                   	push   %eax
    22fe:	68 28 47 00 00       	push   $0x4728
    2303:	6a 01                	push   $0x1
    ...
    230f:	52                   	push   %edx
    2310:	52                   	push   %edx
    2311:	68 13 47 00 00       	push   $0x4713
    2316:	6a 01                	push   $0x1
    ...
    2322:	51                   	push   %ecx
    2323:	51                   	push   %ecx
    2324:	68 04 50 00 00       	push   $0x5004
    2329:	6a 01                	push   $0x1
    ...
    2335:	53                   	push   %ebx
    2336:	53                   	push   %ebx
    2337:	68 fe 46 00 00       	push   $0x46fe
    233c:	6a 01                	push   $0x1
    ...
    2348:	50                   	push   %eax
    2349:	50                   	push   %eax
    234a:	68 e6 46 00 00       	push   $0x46e6
    234f:	6a 01                	push   $0x1
    ...
    235b:	50                   	push   %eax
    235c:	50                   	push   %eax
    235d:	68 ce 46 00 00       	push   $0x46ce
    2362:	6a 01                	push   $0x1
    ...
    236e:	50                   	push   %eax
    236f:	50                   	push   %eax
    2370:	68 b2 46 00 00       	push   $0x46b2
    2375:	6a 01                	push   $0x1
    ...
    2381:	50                   	push   %eax
    2382:	50                   	push   %eax
    2383:	68 96 46 00 00       	push   $0x4696
    2388:	6a 01                	push   $0x1
    ...
    2394:	50                   	push   %eax
    2395:	50                   	push   %eax
    2396:	68 79 46 00 00       	push   $0x4679
    239b:	6a 01                	push   $0x1
    ...
    23a7:	50                   	push   %eax
    23a8:	50                   	push   %eax
    23a9:	68 5e 46 00 00       	push   $0x465e
    23ae:	6a 01                	push   $0x1
    ...
    23ba:	50                   	push   %eax
    23bb:	50                   	push   %eax
    23bc:	68 8b 45 00 00       	push   $0x458b
    23c1:	6a 01                	push   $0x1
    ...
    23cd:	50                   	push   %eax
    23ce:	50                   	push   %eax
    23cf:	68 73 45 00 00       	push   $0x4573
    23d4:	6a 01                	push   $0x1
...
000023e0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23ed:	68 45 47 00 00       	push   $0x4745
    23f2:	6a 01                	push   $0x1
    23f4:	e8 97 15 00 00       	call   3990 <printf>
  unlink("bigwrite");
    23f9:	c7 04 24 54 47 00 00 	movl   $0x4754,(%esp)
    ...
    2418:	68 54 47 00 00       	push   $0x4754
    ...
    242e:	53                   	push   %ebx
    242f:	68 40 85 00 00       	push   $0x8540
    2434:	50                   	push   %eax
    ...
    2444:	53                   	push   %ebx
    2445:	68 40 85 00 00       	push   $0x8540
    244a:	56                   	push   %esi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2466:	c7 04 24 54 47 00 00 	movl   $0x4754,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2480:	68 87 47 00 00       	push   $0x4787
    2485:	6a 01                	push   $0x1
    ...
    2496:	50                   	push   %eax
    2497:	53                   	push   %ebx
    2498:	68 75 47 00 00       	push   $0x4775
    249d:	6a 01                	push   $0x1
    ...
    24ac:	68 5d 47 00 00       	push   $0x475d
    24b1:	6a 01                	push   $0x1
...
000024c0 <bigfile>:
{
  ...
  fd = open("bigfile", 0);
    ...
    254e:	5f                   	pop    %edi
    254f:	6a 00                	push   $0x0
    2551:	68 b0 47 00 00       	push   $0x47b0
  ...
  for(i = 0; ; i++){
    ...
    257b:	0f be 05 40 85 00 00 	movsbl 0x8540,%eax
    2582:	89 fa                	mov    %edi,%edx
    2584:	d1 fa                	sar    %edx
    2586:	39 d0                	cmp    %edx,%eax
    2588:	75 6e                	jne    25f8 <bigfile+0x138>
    258a:	0f be 15 6b 86 00 00 	movsbl 0x866b,%edx
  ...
  for(i = 0; ; i++){
    ...
    25a6:	68 40 85 00 00       	push   $0x8540
    25ab:	56                   	push   %esi
  ...
  unlink("bigfile");
    ...
    25d5:	68 b0 47 00 00       	push   $0x47b0
    25da:	e8 93 12 00 00       	call   3872 <unlink>
  printf(1, "bigfile test ok\n");
    25df:	58                   	pop    %eax
    25e0:	5a                   	pop    %edx
    25e1:	68 3f 48 00 00       	push   $0x483f
    25e6:	6a 01                	push   $0x1
    ...
    25fb:	68 0c 48 00 00       	push   $0x480c
    2600:	6a 01                	push   $0x1
    ...
    260f:	68 f8 47 00 00       	push   $0x47f8
    2614:	6a 01                	push   $0x1
    ...
    2623:	68 e3 47 00 00       	push   $0x47e3
    2628:	6a 01                	push   $0x1
    ...
    2637:	68 b8 47 00 00       	push   $0x47b8
    263c:	6a 01                	push   $0x1
    ...
    2648:	53                   	push   %ebx
    2649:	53                   	push   %ebx
    264a:	68 ce 47 00 00       	push   $0x47ce
    264f:	6a 01                	push   $0x1
    ...
    265b:	50                   	push   %eax
    265c:	50                   	push   %eax
    265d:	68 a2 47 00 00       	push   $0x47a2
    2662:	6a 01                	push   $0x1
    ...
    266e:	51                   	push   %ecx
    266f:	51                   	push   %ecx
    2670:	68 25 48 00 00       	push   $0x4825
    2675:	6a 01                	push   $0x1
...
00002690 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    2696:	68 50 48 00 00       	push   $0x4850
    269b:	6a 01                	push   $0x1
    269d:	e8 ee 12 00 00       	call   3990 <printf>
  if(mkdir("12345678901234") != 0){
    26a2:	c7 04 24 8b 48 00 00 	movl   $0x488b,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26bc:	68 24 50 00 00       	push   $0x5024
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26d9:	68 74 50 00 00       	push   $0x5074
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26f8:	5a                   	pop    %edx
    26f9:	6a 00                	push   $0x0
    26fb:	68 e4 50 00 00       	push   $0x50e4
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2715:	c7 04 24 7c 48 00 00 	movl   $0x487c,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    272b:	68 80 51 00 00       	push   $0x5180
  ...
  printf(1, "fourteen ok\n");
    ...
    273f:	68 9a 48 00 00       	push   $0x489a
    2744:	6a 01                	push   $0x1
    ...
    2750:	50                   	push   %eax
    2751:	50                   	push   %eax
    2752:	68 5f 48 00 00       	push   $0x485f
    2757:	6a 01                	push   $0x1
    ...
    2763:	50                   	push   %eax
    2764:	50                   	push   %eax
    2765:	68 a0 51 00 00       	push   $0x51a0
    276a:	6a 01                	push   $0x1
    ...
    2776:	52                   	push   %edx
    2777:	52                   	push   %edx
    2778:	68 50 51 00 00       	push   $0x5150
    277d:	6a 01                	push   $0x1
    ...
    2789:	51                   	push   %ecx
    278a:	51                   	push   %ecx
    278b:	68 14 51 00 00       	push   $0x5114
    2790:	6a 01                	push   $0x1
    ...
    279c:	51                   	push   %ecx
    279d:	51                   	push   %ecx
    279e:	68 a4 50 00 00       	push   $0x50a4
    27a3:	6a 01                	push   $0x1
    ...
    27af:	50                   	push   %eax
    27b0:	50                   	push   %eax
    27b1:	68 44 50 00 00       	push   $0x5044
    27b6:	6a 01                	push   $0x1
...
000027d0 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    27d6:	68 a7 48 00 00       	push   $0x48a7
    27db:	6a 01                	push   $0x1
    27dd:	e8 ae 11 00 00       	call   3990 <printf>
  if(mkdir("dots") != 0){
    27e2:	c7 04 24 b3 48 00 00 	movl   $0x48b3,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    27fc:	68 b3 48 00 00       	push   $0x48b3
  ...
  if(unlink(".") == 0){
    ...
    2814:	68 5e 45 00 00       	push   $0x455e
  ...
  if(unlink("..") == 0){
    ...
    282c:	68 5d 45 00 00       	push   $0x455d
  ...
  if(chdir("/") != 0){
    ...
    2844:	68 31 3d 00 00       	push   $0x3d31
  ...
  if(unlink("dots/.") == 0){
    ...
    285c:	68 fb 48 00 00       	push   $0x48fb
  ...
  if(unlink("dots/..") == 0){
    ...
    2870:	68 19 49 00 00       	push   $0x4919
  ...
  if(unlink("dots") != 0){
    ...
    2884:	68 b3 48 00 00       	push   $0x48b3
  ...
  printf(1, "rmdot ok\n");
    ...
    2898:	68 4e 49 00 00       	push   $0x494e
    289d:	6a 01                	push   $0x1
    ...
    28a9:	50                   	push   %eax
    28aa:	50                   	push   %eax
    28ab:	68 b8 48 00 00       	push   $0x48b8
    28b0:	6a 01                	push   $0x1
    ...
    28bc:	50                   	push   %eax
    28bd:	50                   	push   %eax
    28be:	68 39 49 00 00       	push   $0x4939
    28c3:	6a 01                	push   $0x1
    ...
    28cf:	52                   	push   %edx
    28d0:	52                   	push   %edx
    28d1:	68 21 49 00 00       	push   $0x4921
    28d6:	6a 01                	push   $0x1
    ...
    28e2:	51                   	push   %ecx
    28e3:	51                   	push   %ecx
    28e4:	68 02 49 00 00       	push   $0x4902
    28e9:	6a 01                	push   $0x1
    ...
    28f5:	50                   	push   %eax
    28f6:	50                   	push   %eax
    28f7:	68 33 3d 00 00       	push   $0x3d33
    28fc:	6a 01                	push   $0x1
    ...
    2908:	50                   	push   %eax
    2909:	50                   	push   %eax
    290a:	68 ec 48 00 00       	push   $0x48ec
    290f:	6a 01                	push   $0x1
    ...
    291b:	50                   	push   %eax
    291c:	50                   	push   %eax
    291d:	68 de 48 00 00       	push   $0x48de
    2922:	6a 01                	push   $0x1
    ...
    292e:	50                   	push   %eax
    292f:	50                   	push   %eax
    2930:	68 cb 48 00 00       	push   $0x48cb
    2935:	6a 01                	push   $0x1
...
00002950 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2957:	68 58 49 00 00       	push   $0x4958
    295c:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    296a:	68 65 49 00 00       	push   $0x4965
  ...
  if(chdir("dirfile") == 0){
    2988:	c7 04 24 65 49 00 00 	movl   $0x4965,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    29a2:	6a 00                	push   $0x0
    29a4:	68 9e 49 00 00       	push   $0x499e
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29c1:	68 9e 49 00 00       	push   $0x499e
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29d9:	68 9e 49 00 00       	push   $0x499e
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    29f1:	68 9e 49 00 00       	push   $0x499e
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a09:	68 9e 49 00 00       	push   $0x499e
    2a0e:	68 02 4a 00 00       	push   $0x4a02
  ...
  if(unlink("dirfile") != 0){
    ...
    2a26:	68 65 49 00 00       	push   $0x4965
  ...
  fd = open(".", O_RDWR);
    ...
    2a3e:	6a 02                	push   $0x2
    2a40:	68 5e 45 00 00       	push   $0x455e
  ...
  fd = open(".", 0);
    ...
    2a58:	6a 00                	push   $0x0
    2a5a:	68 5e 45 00 00       	push   $0x455e
  ...
  if(write(fd, "x", 1) > 0){
    2a69:	6a 01                	push   $0x1
    2a6b:	68 41 46 00 00       	push   $0x4641
    2a70:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2a86:	58                   	pop    %eax
    2a87:	5a                   	pop    %edx
    2a88:	68 35 4a 00 00       	push   $0x4a35
    2a8d:	6a 01                	push   $0x1
    ...
    2a9c:	50                   	push   %eax
    2a9d:	50                   	push   %eax
    2a9e:	68 a9 49 00 00       	push   $0x49a9
    2aa3:	6a 01                	push   $0x1
    ...
    2aaf:	50                   	push   %eax
    2ab0:	50                   	push   %eax
    2ab1:	68 84 49 00 00       	push   $0x4984
    2ab6:	6a 01                	push   $0x1
    ...
    2ac2:	52                   	push   %edx
    2ac3:	52                   	push   %edx
    2ac4:	68 6d 49 00 00       	push   $0x496d
    2ac9:	6a 01                	push   $0x1
    ...
    2ad5:	51                   	push   %ecx
    2ad6:	51                   	push   %ecx
    2ad7:	68 21 4a 00 00       	push   $0x4a21
    2adc:	6a 01                	push   $0x1
    ...
    2ae8:	53                   	push   %ebx
    2ae9:	53                   	push   %ebx
    2aea:	68 f4 51 00 00       	push   $0x51f4
    2aef:	6a 01                	push   $0x1
    ...
    2afb:	50                   	push   %eax
    2afc:	50                   	push   %eax
    2afd:	68 09 4a 00 00       	push   $0x4a09
    2b02:	6a 01                	push   $0x1
    ...
    2b0e:	50                   	push   %eax
    2b0f:	50                   	push   %eax
    2b10:	68 d4 51 00 00       	push   $0x51d4
    2b15:	6a 01                	push   $0x1
    ...
    2b21:	50                   	push   %eax
    2b22:	50                   	push   %eax
    2b23:	68 e4 49 00 00       	push   $0x49e4
    2b28:	6a 01                	push   $0x1
    ...
    2b34:	50                   	push   %eax
    2b35:	50                   	push   %eax
    2b36:	68 c7 49 00 00       	push   $0x49c7
    2b3b:	6a 01                	push   $0x1
    ...
    2b54:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2b5c:	68 45 4a 00 00       	push   $0x4a45
    2b61:	6a 01                	push   $0x1
    ...
    2b73:	68 56 4a 00 00       	push   $0x4a56
    ...
    2b8b:	68 56 4a 00 00       	push   $0x4a56
    ...
    2ba3:	68 0b 41 00 00       	push   $0x410b
    2ba8:	e8 dd 0c 00 00       	call   388a <mkdir>
    link("README", "");
    2bad:	59                   	pop    %ecx
    2bae:	58                   	pop    %eax
    2baf:	68 0b 41 00 00       	push   $0x410b
    2bb4:	68 02 4a 00 00       	push   $0x4a02
    2bb9:	e8 c4 0c 00 00       	call   3882 <link>
    fd = open("", O_CREATE);
    2bbe:	58                   	pop    %eax
    2bbf:	5a                   	pop    %edx
    2bc0:	68 00 02 00 00       	push   $0x200
    2bc5:	68 0b 41 00 00       	push   $0x410b
    ...
    2bea:	68 40 46 00 00       	push   $0x4640
    ...
    2c0a:	68 40 46 00 00       	push   $0x4640
  ...
  chdir("/");
    ...
    2c23:	68 31 3d 00 00       	push   $0x3d31
    2c28:	e8 65 0c 00 00       	call   3892 <chdir>
  printf(1, "empty file name OK\n");
    2c2d:	58                   	pop    %eax
    2c2e:	5a                   	pop    %edx
    2c2f:	68 84 4a 00 00       	push   $0x4a84
    2c34:	6a 01                	push   $0x1
    ...
    2c46:	68 5c 4a 00 00       	push   $0x4a5c
    2c4b:	6a 01                	push   $0x1
    ...
    2c5a:	68 70 4a 00 00       	push   $0x4a70
    2c5f:	6a 01                	push   $0x1
    ...
    2c74:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2c79:	68 98 4a 00 00       	push   $0x4a98
    2c7e:	6a 01                	push   $0x1
  ...
  printf(1, "fork test OK\n");
    ...
    2ccb:	68 ca 4a 00 00       	push   $0x4aca
    2cd0:	6a 01                	push   $0x1
    ...
    2ce3:	68 14 52 00 00       	push   $0x5214
    2ce8:	6a 01                	push   $0x1
    ...
    2cfc:	68 a3 4a 00 00       	push   $0x4aa3
    2d01:	6a 01                	push   $0x1
    ...
    2d0d:	50                   	push   %eax
    2d0e:	50                   	push   %eax
    2d0f:	68 b7 4a 00 00       	push   $0x4ab7
    2d14:	6a 01                	push   $0x1
    ...
    2d26:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    2d2b:	68 d8 4a 00 00       	push   $0x4ad8
    2d30:	ff 35 4c 5d 00 00    	pushl  0x5d4c
  ...
  *lastaddr = 99;
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f4a:	6a 01                	push   $0x1
    2f4c:	68 41 46 00 00       	push   $0x4641
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fbe:	68 80 4b 00 00       	push   $0x4b80
    2fc3:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    2fdd:	56                   	push   %esi
    2fde:	57                   	push   %edi
    2fdf:	68 e3 4a 00 00       	push   $0x4ae3
    2fe4:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    3010:	50                   	push   %eax
    3011:	50                   	push   %eax
    3012:	68 65 4b 00 00       	push   $0x4b65
    3017:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    3027:	52                   	push   %edx
    3028:	52                   	push   %edx
    3029:	68 21 40 00 00       	push   $0x4021
    302e:	6a 01                	push   $0x1
    ...
    303d:	50                   	push   %eax
    303e:	56                   	push   %esi
    303f:	68 4c 4b 00 00       	push   $0x4b4c
    3044:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    305c:	51                   	push   %ecx
    305d:	51                   	push   %ecx
    305e:	68 29 4c 00 00       	push   $0x4c29
    3063:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    3073:	50                   	push   %eax
    3074:	56                   	push   %esi
    3075:	68 08 53 00 00       	push   $0x5308
    307a:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    308a:	53                   	push   %ebx
    308b:	53                   	push   %ebx
    308c:	68 d8 52 00 00       	push   $0x52d8
    3091:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    30a1:	57                   	push   %edi
    30a2:	56                   	push   %esi
    30a3:	68 b0 52 00 00       	push   $0x52b0
    30a8:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    30b8:	50                   	push   %eax
    30b9:	56                   	push   %esi
    30ba:	68 78 52 00 00       	push   $0x5278
    30bf:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    30cf:	56                   	push   %esi
    30d0:	56                   	push   %esi
    30d1:	68 31 4b 00 00       	push   $0x4b31
    30d6:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    30e6:	57                   	push   %edi
    30e7:	57                   	push   %edi
    30e8:	68 38 52 00 00       	push   $0x5238
    30ed:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    3102:	50                   	push   %eax
    3103:	50                   	push   %eax
    3104:	68 15 4b 00 00       	push   $0x4b15
    3109:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    3119:	50                   	push   %eax
    311a:	50                   	push   %eax
    311b:	68 fe 4a 00 00       	push   $0x4afe
    3120:	ff 35 4c 5d 00 00    	pushl  0x5d4c
...
00003140 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    314a:	68 8e 4b 00 00       	push   $0x4b8e
    314f:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    318f:	5a                   	pop    %edx
    3190:	53                   	push   %ebx
    3191:	68 9d 4b 00 00       	push   $0x4b9d
  ...
  printf(stdout, "validate ok\n");
    ...
    31b4:	68 c1 4b 00 00       	push   $0x4bc1
    31b9:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    31d6:	68 a8 4b 00 00       	push   $0x4ba8
    31db:	ff 35 4c 5d 00 00    	pushl  0x5d4c
...
000031f0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    31f6:	68 ce 4b 00 00       	push   $0x4bce
    31fb:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    3201:	e8 8a 07 00 00       	call   3990 <printf>
    if(uninit[i] != '\0'){
    3206:	83 c4 10             	add    $0x10,%esp
    3209:	80 3d 20 5e 00 00 00 	cmpb   $0x0,0x5e20
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    3220:	80 b8 20 5e 00 00 00 	cmpb   $0x0,0x5e20(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    3236:	68 e9 4b 00 00       	push   $0x4be9
    323b:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    324e:	68 d8 4b 00 00       	push   $0x4bd8
    3253:	ff 35 4c 5d 00 00    	pushl  0x5d4c
...
00003270 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3276:	68 f6 4b 00 00       	push   $0x4bf6
  ...
  fd = open("bigarg-ok", 0);
    ...
    329a:	6a 00                	push   $0x0
    329c:	68 f6 4b 00 00       	push   $0x4bf6
  ...
  unlink("bigarg-ok");
    32ba:	c7 04 24 f6 4b 00 00 	movl   $0x4bf6,(%esp)
    32c1:	e8 ac 05 00 00       	call   3872 <unlink>
}
    32c6:	83 c4 10             	add    $0x10,%esp
    32c9:	c9                   	leave  
    32ca:	c3                   	ret    
    32cb:	b8 80 5d 00 00       	mov    $0x5d80,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    32d0:	c7 00 2c 53 00 00    	movl   $0x532c,(%eax)
    32d6:	83 c0 04             	add    $0x4,%eax
    for(i = 0; i < MAXARG-1; i++)
    32d9:	3d fc 5d 00 00       	cmp    $0x5dfc,%eax
    32de:	75 f0                	jne    32d0 <bigargtest+0x60>
    printf(stdout, "bigarg test\n");
    32e0:	51                   	push   %ecx
    32e1:	51                   	push   %ecx
    32e2:	68 00 4c 00 00       	push   $0x4c00
    32e7:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    args[MAXARG-1] = 0;
    32ed:	c7 05 fc 5d 00 00 00 	movl   $0x0,0x5dfc
    32f4:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    32fc:	58                   	pop    %eax
    32fd:	5a                   	pop    %edx
    32fe:	68 80 5d 00 00       	push   $0x5d80
    3303:	68 cd 3d 00 00       	push   $0x3dcd
    3308:	e8 4d 05 00 00       	call   385a <exec>
    printf(stdout, "bigarg test ok\n");
    330d:	59                   	pop    %ecx
    330e:	58                   	pop    %eax
    330f:	68 0d 4c 00 00       	push   $0x4c0d
    3314:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    331a:	e8 71 06 00 00       	call   3990 <printf>
    fd = open("bigarg-ok", O_CREATE);
    331f:	58                   	pop    %eax
    3320:	5a                   	pop    %edx
    3321:	68 00 02 00 00       	push   $0x200
    3326:	68 f6 4b 00 00       	push   $0x4bf6
    ...
    333d:	50                   	push   %eax
    333e:	50                   	push   %eax
    333f:	68 36 4c 00 00       	push   $0x4c36
    3344:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    3354:	52                   	push   %edx
    3355:	52                   	push   %edx
    3356:	68 1d 4c 00 00       	push   $0x4c1d
    335b:	ff 35 4c 5d 00 00    	pushl  0x5d4c
    ...
    3376:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    337b:	68 4b 4c 00 00       	push   $0x4c4b
    3380:	6a 01                	push   $0x1
    ...
    3403:	50                   	push   %eax
    3404:	68 58 4c 00 00       	push   $0x4c58
    3409:	6a 01                	push   $0x1
    ...
    343a:	68 40 85 00 00       	push   $0x8540
    343f:	57                   	push   %edi
    ...
    3452:	56                   	push   %esi
    3453:	68 74 4c 00 00       	push   $0x4c74
    3458:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3486:	50                   	push   %eax
    3487:	68 64 4c 00 00       	push   $0x4c64
    348c:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    351a:	68 84 4c 00 00       	push   $0x4c84
    351f:	6a 01                	push   $0x1
...
00003540 <uio>:
{
  ...
  printf(1, "uio test\n");
    3546:	68 9a 4c 00 00       	push   $0x4c9a
    354b:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    3568:	68 a4 4c 00 00       	push   $0x4ca4
    356d:	6a 01                	push   $0x1
    ...
    358a:	52                   	push   %edx
    358b:	52                   	push   %edx
    358c:	68 0c 54 00 00       	push   $0x540c
    3591:	6a 01                	push   $0x1
    ...
    359d:	50                   	push   %eax
    359e:	50                   	push   %eax
    359f:	68 29 4c 00 00       	push   $0x4c29
    35a4:	6a 01                	push   $0x1
...
000035b0 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    35b0:	69 05 48 5d 00 00 0d 	imul   $0x19660d,0x5d48,%eax
    35b7:	66 19 00 
{
    35ba:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    35c3:	a3 48 5d 00 00       	mov    %eax,0x5d48
}
    35c8:	c3                   	ret    
    ...
    38f9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    3927:	f7 f1                	div    %ecx
    3929:	0f b6 92 64 54 00 00 	movzbl 0x5464(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3b44:	e9 8f fe ff ff       	jmp    39d8 <printf+0x48>
          s = "(null)";
    3b49:	bb 5c 54 00 00       	mov    $0x545c,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3b61:	a1 00 5e 00 00       	mov    0x5e00,%eax
{
  ...
  freep = p;
    3b9f:	a3 00 5e 00 00       	mov    %eax,0x5e00
}
    3ba4:	5b                   	pop    %ebx
    3ba5:	5e                   	pop    %esi
    3ba6:	5f                   	pop    %edi
    ...
    3bb6:	72 ce                	jb     3b86 <free+0x26>
{
  ...
  freep = p;
    3bda:	a3 00 5e 00 00       	mov    %eax,0x5e00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3bfc:	8b 15 00 5e 00 00    	mov    0x5e00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3c41:	39 05 00 5e 00 00    	cmp    %eax,0x5e00
  ...
  return freep;
    3c6b:	8b 15 00 5e 00 00    	mov    0x5e00,%edx
    ...
    3c94:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3c97:	89 15 00 5e 00 00    	mov    %edx,0x5e00
}
    ...
    base.s.ptr = freep = prevp = &base;
    3cb0:	c7 05 00 5e 00 00 04 	movl   $0x5e04,0x5e00
    3cb7:	5e 00 00 
    3cba:	c7 05 04 5e 00 00 04 	movl   $0x5e04,0x5e04
    3cc1:	5e 00 00 
    base.s.size = 0;
    3cc4:	b8 04 5e 00 00       	mov    $0x5e04,%eax
    3cc9:	c7 05 08 5e 00 00 00 	movl   $0x0,0x5e08
    3cd0:	00 00 00 
