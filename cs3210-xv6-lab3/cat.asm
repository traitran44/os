...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 45 03 00 00       	call   381 <open>
  ...
  57:	e8 0d 03 00 00       	call   369 <close>
  for(i = 1; i < argc; i++){
  ...
  73:	e8 38 04 00 00       	call   4b0 <printf>
      exit();
  78:	e8 c4 02 00 00       	call   341 <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 b5 02 00 00       	call   341 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 b1 02 00 00       	call   361 <write>
  ...
  c0:	53                   	push   %ebx
  c1:	e8 93 02 00 00       	call   359 <read>
  ...
  dd:	e8 ce 03 00 00       	call   4b0 <printf>
    exit();
  e2:	e8 5a 02 00 00       	call   341 <exit>
  e7:	66 90                	xchg   %ax,%ax
  e9:	66 90                	xchg   %ax,%ax
  eb:	66 90                	xchg   %ax,%ax
  ed:	66 90                	xchg   %ax,%ax
